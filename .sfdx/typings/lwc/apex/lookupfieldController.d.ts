...
declare module "@salesforce/apex/lookupfieldController.SearchRecords" {
  export default function SearchRecords(param: {ObjectName: any, ReturnFields: any, QueryFields: any, SearchText: any, SortColumn: any, SortOrder: any, MaxResults: any, Filter: any}): Promise<any>;
}
